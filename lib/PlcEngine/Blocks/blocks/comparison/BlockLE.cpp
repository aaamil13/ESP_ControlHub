...
bool BlockLE::configure(const JsonObject& config, PlcMemory& memory) {
...
void BlockLE::evaluate(PlcMemory& memory) {
...
JsonDocument BlockLE::getBlockSchema() {
    JsonDocument schema;
    schema["description"] = "Less Than or Equal comparison block";
