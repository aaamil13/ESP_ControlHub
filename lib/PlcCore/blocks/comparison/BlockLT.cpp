...
bool BlockLT::configure(const JsonObject& config, PlcMemory& memory) {
...
void BlockLT::evaluate(PlcMemory& memory) {
...
JsonDocument BlockLT::getBlockSchema() {
    JsonDocument schema;
    schema["description"] = "Less Than comparison block";
