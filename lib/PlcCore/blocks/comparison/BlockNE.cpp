...
bool BlockNE::configure(const JsonObject& config, PlcMemory& memory) {
...
void BlockNE::evaluate(PlcMemory& memory) {
...
JsonDocument BlockNE::getBlockSchema() {
    JsonDocument schema;
    schema["description"] = "Not Equal comparison block";
