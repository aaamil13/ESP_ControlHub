...
bool BlockEQ::configure(const JsonObject& config, PlcMemory& memory) {
...
void BlockEQ::evaluate(PlcMemory& memory) {
...
JsonDocument BlockEQ::getBlockSchema() {
    JsonDocument schema;
    schema["description"] = "Equality comparison block";
