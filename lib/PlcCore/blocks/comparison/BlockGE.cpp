...
bool BlockGE::configure(const JsonObject& config, PlcMemory& memory) {
...
void BlockGE::evaluate(PlcMemory& memory) {
...
JsonDocument BlockGE::getBlockSchema() {
    JsonDocument schema;
    schema["description"] = "Greater Than or Equal comparison block";
